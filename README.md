# Available .FIT One-Word Domains (29,529)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-29%2C529%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **29,529 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 29,529 domains · **Median ask:** $40.51 · **High-demand under $2,500:** 9
...
| ------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ----------------------------- |
| idle.fit      | available | $2.98     | $45.98        | low            | low    | 4      | namecheap                     |
...
| veggie.fit    | resell    | $2.99     | —             | medium         | low    | 6      | Spaceship, Inc.               |
| age.fit       | premium   | $2,660    | $29.50        | medium         | low    | 3      | namesilo                      |
| pita.fit      | available | $2.99     | —             | high           | low    | 4      | name.com                      |
| dedicated.fit | resell    | $42.99    | $45.99        | medium         | low    | 9      | name.com                      |
...
| cool.fit      | resell    | —         | —             | medium         | low    | 4      | West263 International Limited |
...
| atilt.fit     | available | $2.98     | $45.98        | low            | low    | 5      | namecheap                     |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 29,529 live domains                        |
...
> Unique Domains. *Available .FIT One-Word Domains*. Version 2026-09-24. Public GitHub extract for the exact Unique Domains search represented by this repository.

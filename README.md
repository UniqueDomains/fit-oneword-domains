...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C229%20rows-8250df">
...
**Public extract:** 8,229 rows · **Live catalog:** 8,224 domains
...
- `fit.csv` — public CSV extract (8,229 rows)
- `fit.json` — public JSON extract (8,229 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,229-row public sample | 8,224 live domains                               |
